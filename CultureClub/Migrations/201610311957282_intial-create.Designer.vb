...
Namespace Migrations
    ...
    Public NotInheritable Partial Class intialcreate
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(intialcreate))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201610311957282_intial-create"
            End Get
        End Property
